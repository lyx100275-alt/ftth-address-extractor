...
if args.probe:
    ...
    if args.out:
        ...
        def _guess_params(samples):
            ...
            #   写死 `\d+#`，而真实图纸整类标题可能全写成「N号楼」（实测小区甲 15 条
            ...
            #   串号。实测小区甲：图上 4 个地块各有一整套 FX01~FX28（写作 `FL01FX01`
...
#   --bldg-map 认领；不传则整图 0 箱、rc 仍 0（实测小区甲 4 图 84 个箱、小区乙 23 个箱
...
if BDG_MAP:
    ...
    for _t in texts:
        ...
        #   整批抹平 —— 实测小区甲 8 个地块**全部**表现为「单元数=1、单元名=楼栋名」，
